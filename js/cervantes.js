...
$(document).ready(function() {
	...
	$('#main-text').append('<div class="instruction" style="border: 1px solid;border-radius: 3px; background:#111; color:white; padding: 5px; height: 20px;">To get started, pick a main text to examine:</div>')
});
